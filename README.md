...
Memo adheres to the XDG Base Directory Specification. Your configuration file should be located at: `$XDG_CONFIG_HOME/memo/config`
...
# A boolean flag to enable Neovim integration. Set to 'true' or 'false'.
...
`memo` → Opens the default memo (creates it if missing).
